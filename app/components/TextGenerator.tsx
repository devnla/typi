...
const burmeseWords = [
  ...
  'ကောင်း', 'မကောင်း', 'ကြီး', 'သေး', 'ရှည်', 'တို', 'မြင့်', 'နိမ့်', 'နွေး', 'အေး',
  'ဟုတ်', 'မဟုတ်', 'ရှိ', 'မရှိ', 'ရ', 'မရ', 'တတ်', 'မတတ်', 'သိ', 'မသိ'
];

const burmeseQuotes = [
  // Simple wisdom and everyday sentences
  'ပညာသည် အင်အား ဖြစ်သည်',
  'လုပ်ငန်းမှန် အချိန်နှင့်အညီ လုပ်ပါ',
  'ကြိုးစားမှု အောင်မြင်မှု ရရှိစေသည်',
  'ယနေ့ကို ကောင်းအောင် လုပ်ပါ',
  'အမှားမှ သင်ခန်းစာ ယူပါ',
  
  // Life quotes
  'ကြင်နာမှုသည် အင်အား ဖြစ်သည်',
  'စိတ်ရှည်မှုသည် ပညာ ဖြစ်သည်',
  'မေတ္တာသည် အင်အား ဖြစ်သည်',
  'မိတ်ဆွေကောင်းသည် ရတနာ ဖြစ်သည်',
  'မိသားစုသည် အရေးကြီး ဖြစ်သည်',
  
  // Daily life sentences
  'နံနက်ခင်း ထမင်း စားပါ',
  'ညနေ အိမ်သို့ ပြန်ပါ',
  'စာအုပ် ဖတ်ရန် ကောင်းသည်',
  'အလုပ် လုပ်ရန် အချိန် ရောက်ပြီ',
  'မိုး ရွာနေ သည်ကို ကြည့်ပါ',
  'ကျောင်းသား များ စာ သင်နေကြသည်',
  'ဆရာ က စာ သင်ပေး နေသည်',
  'အမေ က ဟင်း ချက်နေ သည်',
  'အဖေ က အလုပ် လုပ်နေ သည်',
  'ကလေး များ ကစား နေကြ သည်'
];
