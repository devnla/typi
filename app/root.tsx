  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="Typi" />
        <meta name="description" content="A beautiful, modern typing speed test application with enhanced Burmese language support" />
