...
function HomeContent() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-gray-50 dark:bg-gray-900 transition-colors duration-200 flex flex-col">
      ...
      {/* Main Content */}
      <main className="flex-1 max-w-6xl mx-auto px-6 py-4 overflow-hidden flex flex-col">
        {currentView === 'test' && (
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden relative">
              <TypingTest
                key={testKey}
                text={currentText}
